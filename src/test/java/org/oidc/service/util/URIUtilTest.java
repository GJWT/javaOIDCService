...
public class URIUtilTest {
    ...
    @Test
    public void testNormalizeUrlNullUrl() {
        thrown.expect(IllegalArgumentException.class);
    ...
    @Test
    public void testNormalizeUrlEmptyUrl() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("null or empty url");
    ...
    @Test
    public void testNormalizeUrlThatsAlreadyBeenNormalizedForDevice() {
    ...
    @Test
    public void testNormalizeUrlThatsAlreadyBeenNormalizedForAcct() {
