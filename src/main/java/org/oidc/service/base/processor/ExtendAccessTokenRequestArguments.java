...
/**
 * This class extends the access token arguments by arguments located from originating authorization
 * request and response.
 */
public class ExtendAccessTokenRequestArguments extends AbstractRequestArgumentProcessor {
