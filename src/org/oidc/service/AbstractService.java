...
/*if(response instanceof AuthorizationResponse && Strings.isNullOrEmpty(response.getScope())) {
    ...
    public Message postParseResponse(Message response, String stateKey) {
...
/**
    ...
    //todo: default implementation is that service will instatiate specific request
    //this is the method where pre/postConstruct will be applied based on a service type
    public abstract Message constructRequest();
