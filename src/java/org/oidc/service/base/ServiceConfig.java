...
public class ServiceConfig {
    ...
    /**
     * A URL defined where this service can be found at the Authorization
     * server
     */
    private String endpoint;
    /**
     * Which client authentication method that should be used for this
     * service if any.
     */
    ...
    /**
     * The deserialization method to be used when deserializing the
     * response
     */
