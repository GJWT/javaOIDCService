 ...
 * request-response protocol such as OIDC, OAuth2 etc.
 */
public interface Service {
     ...
     */
    HttpArguments getRequestParameters(Map<String, String> requestArguments) throws Exception;
    ...
    /**
     ...
     This method only takes the String version of the response in order for the response to be parsed.
     The serialization format will default to the service’s responseBodyType value.  This method does
     not require a stateKey since it is used for services that are not expected to store state in the
     state DB.
    ...
    /**
     ...
     This method takes the String version of the response and the serializationType in order
     for the response to be parsed.  This method does not require a stateKey since it is used
     for services that are not expected to store state in the state DB.
     ...
     * It requires response and stateKey in order for the service context to be updated.
     * StateKey is used to fetch and update the appropriate State associated with a specific service.
     * This method may update certain attributes of the service context such as issuer, clientId,
     * or clientSecret.
    ...
    /**
     * This method will run after the response has been parsed and verified.
     * It requires response in order for the service context to be updated.
     * This method may update certain attributes of the service context such as issuer,
     * clientId, or clientSecret.  This method does not require a stateKey since it is used for
